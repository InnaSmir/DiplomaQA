...
### Интервальная оценка с учетом рисков (в часах): 70 - 90 часов.

### План сдачи работ

1. Завершение кодирования тестов: 23.06.2021 (написание плана тестирования, настройка окружения, написание и отладка автотестов, само тестирование)
2. Предоставление отчетности: 28.06.2021
