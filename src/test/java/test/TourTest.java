...
public class TourTest {
    ...
    @DisplayName("3.BuG Оплата в кредит не успешная должно появляться окно с ошибкой и таблица заполняться Decline")
    @Test
    ...
    @DisplayName("4. BUG Оплата не в кредит, не успешная операция должно появляться окно с ошибкой " +
